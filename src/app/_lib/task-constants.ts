...
export type View = "dashboard" | "tasks" | "tasks-admin" | "team" | "leave" | "excel" | "settings" | "analytics" | "fixed-reports" | "supervisor-projects" | "supervisor-team";
...
export const PRIORITY: Record<Priority, { label: string; color: string; icon: string }> = {
