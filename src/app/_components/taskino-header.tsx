      ...
      <div className="flex items-center gap-3 px-3 py-2.5">
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
            ...
            {showNotifications && (
              <div className="absolute left-0 top-11 z-50 w-80 overflow-hidden rounded-xl border border-[--border] bg-[--surface] shadow-xl">
                <div className="flex items-center justify-between border-b border-[--border] px-4 py-3">
                  ...
                  {unreadCount > 0 && (
                    <button className="text-xs font-semibold text-[#1f7a8c] hover:underline" onClick={onMarkAllNotificationsRead} type="button">
                      همه خوانده شد
                    </button>
                  )}
                </div>
          ...
          >
            ...
            <span className="hidden max-w-[90px] truncate text-xs sm:block">{userName(currentUser ?? undefined)}</span>
